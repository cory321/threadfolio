  ...
  return (
    ...
    >
      <p>
        ...
        <Link href='https://bytelogic.agency' target='_blank' className='text-primary'>
          ByteLogic Agency
        </Link>
      </p>
      {!isBreakpointReached && <div className='flex items-center gap-4'>{/* Additional metadata will go here */}</div>}
    </div>
  )
}
